...
import ButtonLightGrey from "../assets/components/Buttons/ButtonLightGrey";
...
function Detail({ data, darkMode, setDarkMode, toggleDarkMode, detail, setDetail }) {
    ...
    <>
      <div className="flex flex-col bg-custom_light_grey min-h-screen dark:bg-custom_midnight">
        ...
        <header
          ...
          className={`w-full h-[136px] bg-no-repeat bg-cover  `}
        >
          <div className="flex items-center justify-between max-w-[1100px] py-8 w-10/12 mx-auto">
            {/* brand logo*/}
            <a
              href="/"
              title="brand-logo"
              onClick={() => {
                setDetail({ ...detail, isActived: false, idCompany: null });
              }}
            >
              <figure>
        ...
        <main className="w-full">
          <section className="-mt-10 w-10/12 mx-auto flex flex-col gap-14 sm:max-w-[730px]">
            {/* item part 1*/}
            {detail.isActived && (
              <>
                <div className="bg-white p-6 text-center flex flex-col gap-6 rounded-md  relative dark:bg-custom_very_dark_blue sm:p-0 sm:flex-row sm:justify-between sm:items-center sm:h-[140px] ">
                  {/* logo item Scoot */}
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Scoot" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#E99210] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                  ...
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Blogr" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#E54D25] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                  ...
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Vector" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#34353F] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                  ...
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Office Lite" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#2F4FC7] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                      <svg
                  ...
                  {/* logo item Pod */}
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company == "Pod" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#132034] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                  ...
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Creative" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#4E1853] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                  ...
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Pomodoro" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#4722C6] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                  ...
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Maker" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#21427D] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                  ...
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Coffeeroasters" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#F2DECB] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                        <path
                          fill="#0E8784"
                  ...
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Mastercraft" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#1F1F1F] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                      <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26">
                        <g fill="none">
                          <path
                            fill="#444"
                  ...
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Crowdfund" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#37C790] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                  ...
                  {data[data.findIndex((item) => item.id == detail.idCompany)].company ==
                    "Typemaster" && (
                    <figure className="absolute top-[-24px] left-[50%] translate-x-[-50%] h-[50px] w-[50px] bg-[#F16718] rounded-2xl flex justify-center items-center sm:static sm:translate-x-0 sm:h-[140px] sm:w-[140px] sm:rounded-t-[0px] sm:rounded-br-[0px]">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                        <g fill="none" fillRule="evenodd">
                  ...
                  {/* item header */}
                  <div className="mt-6 sm:text-left sm:mr-auto sm:mt-0">
                    <h1 className="font-bold text-xl dark:text-white">
                      {data[data.findIndex((item) => item.id == detail.idCompany)].company}
                    </h1>
                    <p className="text-custom_dark_grey lowercase">
                      {data[data.findIndex((item) => item.id == detail.idCompany)].company.replace(
                        /\s+/g,
                        ""
                      ) + ".com"}
                    </p>
                  </div>
                  <div className="flex justify-center sm:pr-10">
                    <a
                      href={data[data.findIndex((item) => item.id == detail.idCompany)].website}
                      target="_blank"
                    >
                      <ButtonLightGrey
                        className={
                          "bg-custom_light_grey rounded-[5px] text-custom_violet font-bold flex  justify-center w-max px-10 py-4 hover:bg-[#5964e059] dark:bg-[#5964e018] dark:text-custom_violet dark:hover:bg-custom_dark_grey sm:dark:text-white sm:dark:bg-[rgba(255,255,255,0.1)]"
                        }
                        text={"Company Site"}
                      ></ButtonLightGrey>
                    </a>
                ...
                {/* item part 2 */}
                <div className="flex flex-col p-4 sm:p-12 gap-8 bg-white rounded-md  relative dark:bg-custom_very_dark_blue">
                  {/* item header*/}
                  <div className="flex flex-col gap-10 sm:flex-row sm:justify-between sm:items-center ">
                    <div className="flex flex-col">
                      <div className="flex gap-2 items-center mt-6 sm:mt-0">
                        <p className="font-normal text-custom_dark_grey">
                          {data[data.findIndex((item) => item.id == detail.idCompany)].postedAt}
                        </p>
                        <div className="h-[4px] w-[4px] rounded-full bg-custom_dark_grey"></div>
                        <p className="font-normal text-custom_dark_grey">
                          {data[data.findIndex((item) => item.id == detail.idCompany)].contract}
                        </p>
                      </div>
                      <h2 className="font-bold text-xl text-left text-custom_very_dark_blue dark:text-white">
                        {data[data.findIndex((item) => item.id == detail.idCompany)].position}
                      </h2>

                      <p className="font-bold text-sm text-custom_violet">
                        {data[data.findIndex((item) => item.id == detail.idCompany)].location}
                      </p>
                    </div>
                    {/* item apply*/}
                    <div className="">
                      <a
                        href={data[data.findIndex((item) => item.id == detail.idCompany)].apply}
                        target="_blank"
                      >
                        <ButtonViolet
                          className={
                            "bg-custom_violet rounded-[5px] text-white font-bold flex justify-center w-full sm:w-max px-10 py-4 hover:bg-custom_light_violet"
                          }
                          text={"Apply Now"}
                        ></ButtonViolet>
                      </a>
                  ...
                  {/* item description*/}
                  <p className="text-custom_dark_grey font-normal">
                    {data[data.findIndex((item) => item.id == detail.idCompany)].description}
                  </p>
                  <h3 className="text-custom_very_dark_blue font-bold text-xl dark:text-white">
                    Requirements
                  </h3>
                  <p className="text-custom_dark_grey font-normal">
                    {
                      data[data.findIndex((item) => item.id == detail.idCompany)].requirements
                        .content
                    }
                  </p>
                  <ul className="list-none text-custom_dark_grey flex flex-col">
                    {data[
                      data.findIndex((item) => item.id == detail.idCompany)
                    ].requirements.items.map((item, index) => (
                      <div key={index} className="flex gap-4 items-center">
                        <div className="h-[4px] w-[4px] bg-custom_violet rounded-full self-center"></div>
                        <li>{item}</li>
                      </div>
                    ))}
                  </ul>
                  ...
                  <p className="text-custom_dark_grey font-normal">
                    {data[data.findIndex((item) => item.id == detail.idCompany)].role.content}
                  </p>
                  <ul className="list-none flex flex-col text-custom_dark_grey font-normal">
                    {data[data.findIndex((item) => item.id == detail.idCompany)].role.items.map(
                      (item2, index2) => (
                        <div key={index2} className="flex gap-4 items-center">
                          <div className="text-custom_violet self-center">{++index2}</div>
                          <li>{item2}</li>
                        </div>
                      )
                    )}
          ...
          {/* item apply footer */}
          {detail.isActived && (
            <footer className="bg-white py-6 mt-10 rounded-md dark:bg-custom_very_dark_blue sm:flex">
              <div className="sm:w-10/12 sm:max-w-[730px] sm:mx-auto flex justify-center sm:justify-between">
                <div className="hidden sm:flex sm:flex-col">
                  <h3 className="font-bold text-xl text-left text-custom_very_dark_blue dark:text-white">
                    {data[data.findIndex((item) => item.id == detail.idCompany)].position}
                  </h3>
                  <p className="font-normal text-custom_dark_grey">So Digital inc.</p>
                </div>
                <div className="">
                  <a
                    href={data[data.findIndex((item) => item.id == detail.idCompany)].apply}
                  ...
                  >
                    <ButtonViolet
                      className={
                        "bg-custom_violet rounded-[5px] text-white font-bold flex justify-center px-10 py-4 hover:bg-custom_light_violet"
                      }
                      text={"Apply Now"}
                    ></ButtonViolet>
                  </a>
